...
const Filteration = props => {
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="any" className="ml-4">Any</label>
    </div>
    <div className="contractLabelInputCotainer ">
        <input type="radio" id="hospitality" name="Category"/>  
            <label htmlFor="hospitality" className="ml-4">
                  Hospitality and Catering</label>
    </div>
    <div className="contractLabelInputCotainer">
        <input type="radio" id="property" name="Category"/>
        <label htmlFor="property"  className="ml-4">Construction and Property</label>
    </div>
    <div className="contractLabelInputCotainer">
        <input type="radio" id="cleaning" name="Category"/>
        <label htmlFor="cleaning"  className="ml-4">Housekeeping and Cleaning</label>
    </div>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Beauty"  className="ml-4">Health and Beauty</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Arts"  className="ml-4">Performing Arts</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Sales"  className="ml-4">Sales</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Animals"  className="ml-4">Animals</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Gardening"  className="ml-4">Gardening</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Security"  className="ml-4">Security</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Computer"  className="ml-4">Computer & It</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Social"  className="ml-4">Social & Care Work</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Heritage"  className="ml-4">Arts & Heritage</label>
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="Apprentice"  className="ml-4">Apprenticeship</label>    
    </div>
        
    <div className="contractLabelInputCotainer">
        <input type="radio" id="exp" name="Joblevel"/>
        <label htmlFor="exp"  className="ml-4">Experienced</label>
    </div>
    <div className="contractLabelInputCotainer">
        <input type="radio" id="graduate" name="Joblevel"/>
        <label htmlFor="graduate"  className="ml-4">Graduate</label>
    </div>
    <div className="contractLabelInputCotainer ">
        <input type="radio" id="intern" name="Joblevel"/>
        <label htmlFor="intern"  className="ml-4">Intership</label>
    </div>
    <div className="contractLabelInputCotainer ">
        <input type="radio" id="manage" name="Joblevel"/>
        <label htmlFor="manage"  className="ml-4">Management</label>
    </div>
    </div>
      )
    const LocationDetails = () => {
      ...
      const ContractDetails=()=>(
        ...
        <div className="contractLabelInputCotainer ">
            ...
            <label htmlFor="1"  className="ml-4">contract 11 months</label>
        </div>

        <div className="contractLabelInputCotainer">
            <input type="radio" id="2" name="contract"/>
            <label htmlFor="2"  className="ml-4">Freelance</label>
        </div>

        <div className="contractLabelInputCotainer">
            <input type="radio" id="3" name="contract"/>
            <label htmlFor="3"  className="ml-4">Permanent</label>
        </div>

        <div className="contractLabelInputCotainer ">
            <input type="radio" id="4" name="contract"/>
            <label htmlFor="4"  className="ml-4">Self Employed</label>
        </div>
        </div>
      )
    ...
    <div className="contractLabelInputCotainer ">
        ...
        <label htmlFor="10"  className="ml-4">FullTime</label>
    </div>

    <div className="contractLabelInputCotainer">
        <input type="radio" id="12" name="Hour"/>
        <label htmlFor="12"  className="ml-4">PartTime</label>
    </div>

    <div className="contractLabelInputCotainer">
        <input type="radio" id="13" name="Hour"/>
        <label htmlFor="13"  className="ml-4">Morning</label>
    </div>

    <div className="contractLabelInputCotainer ">
        <input type="radio" id="14" name="Hour"/>
        <label htmlFor="14"  className="ml-4">Self Evening</label>
    </div>
    </div>
      ...
      const recruitertype=()=>(
        <div className="TotalcontractLabelInputCotainer p-3">
            ...
            <label htmlFor="5" className="ml-4">Any</label>
        </div>
        

        <div className="contractLabelInputCotainer ">
            <input type="radio" id="6" name="Recruiter"/>
            <label htmlFor="6" className="ml-4">Direct Employer</label>
        </div>
        <div className="contractLabelInputCotainer ">
            <input type="radio" id="7" name="Recruiter"/>
            <label htmlFor="7" className="ml-4">Recruiter</label>
        </div>
        </div>
      )
    ...
    <div>
        ...
        <div className="gumtree-freelance-cards">
            ...
            <p className="gumtree-freelance-paragraph">Potters Bar, Hertfordshire</p>
            <p className="gumtree-freelance-paragraph">Freelance</p>
            <div className="gumtree-freelance-top-line">
        ...
        <div className="gumtree-freelance-cards">
            ...
            <p className="gumtree-freelance-paragraph">West bridgford, Nottinghamshire</p>
            <p className="gumtree-freelance-paragraph">Freelance</p>
            <div className="gumtree-freelance-top-line">
        ...
        <div className="gumtree-freelance-cards">
            ...
            <h1 className="gumtree-freelance-heading">Book Cover Designers and Book Readers</h1>
